...
export class AddOrderComponent {
  ...
  constructor(
    ...
    this.invoice.set(this.orderService.getInvoiceList());

    // const maxId = Math.max.apply(
    //   Math,
    //   this.orderService.getInvoiceList().map((o) => o.id)
    // );
    this.invoice.set({
      id: 1001,
      status: 'Pending',
  ...
  saveDetail(event: Event): void {
    ...
    this.orderService.addInvoice(this.invoice());
